...
# Lab5: Value-based RL
# Task 3: Enhanced DQN on Atari Pong-v5
#
# Enhancements:
# 1. Double DQN
...
class NStepBuffer:
    """
    Convert 1-step transitions into n-step transitions.

    Input transition:
        state, action, reward, next_state, done

    Output transition:
        state_t, action_t, R_t^(n), state_{t+n}, done, gamma^k
    """
...
class DQNAgent:
    ...
    def train(self):
        ...
        with torch.no_grad():
            # Double DQN:
            # 1. online network selects the next greedy action
...
def main():
    ...
    parser.add_argument("--wandb-run-name", type=str, default="task3_enhanced_dqn")
